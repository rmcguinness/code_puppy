...
| `26e261cd`, `d969c75f`, (the commit making the CLI attach) | Phase 8: `app.Backend`, `internal/client`, the CLI attaching to the service, `--local` |
