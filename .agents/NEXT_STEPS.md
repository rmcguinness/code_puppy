...
| `2e4cb2c0`, `a6ed23d6`, (the commit adding `cmd/code-puppy/serve.go`) | Phase 7: `internal/server`, approvals over the stream, `code-puppy serve`, the workspace lock |
